...
const skillsData = {
  "Programming Languages": ["Java", "Python", "HTML", "CSS", "JavaScript", "React"],
  ...
  "Technical Concepts": ["Object-Oriented Programming", "Data Structures and Algorithms"],
};
        ...
        <div className="mx-auto grid max-w-5xl gap-8 py-12">
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {Object.entries(skillsData).map(([category, skills]) => (
                <Card key={category} className="flex flex-col bg-secondary">
                  <CardHeader>
